...
//            dest.rowInModel = rowInModel
            ...
            dest.session = course.sessions[sessionHistoryTableView.indexPathForSelectedRow!.row]
...
extension SessionHistoryViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
       if editingStyle == .delete {
         course = modelController.remove(session: course.sessions[indexPath.row], from: course)
